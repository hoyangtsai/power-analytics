// https://codepen.io/WebCodePro/pen/wWvexE
...
const mapData = [
  {
    ...
    'value': 22605732,
    'color': '#2463EB',
    sources: { solar: 38, wind: 46, grey: 16 }
  },
  {
    'code': 'CN', 'name': 'China',
    'value': 1347565324,
    'color': '#2463EB',
    sources: { solar: 56, wind: 20, grey: 24 }
  },
  {
    'code': 'JP', 'name': 'Japan',
    'value': 126497241,
    'color': '#2463EB',
    sources: { solar: 36, wind: 36, grey: 28 }
  },
  {
...
export default {
  tooltip: {
    ...
    formatter: (params) => {
      ...
      const { sources } = data;
      if (!sources) {
        return `<div style="border-radius:8px;">
  ...
  series: [
    {
      ...
      data: mapData.map((item) => {
        return {
          name: item.name,
          value: [
            longLat[item.code].longitude,
            longLat[item.code].latitude,
            item.value,
          ],
